...
<script>
    ...
    function showDetail(id) {
        ...
        xmlHttp.send("handle=cyl&action=showDetail&id=" + id);
    }
...
<div>
    <ul>
        <c:forEach items="${cylDatas}" var="data">
            <li style="margin-top: 15px;">
                ...
                <a class="btn btn-danger btn-xs" href="/notify_Web/shfw?handle=cyl&action=delete&id=${data.id}" onclick="return confirm('确定删除这条记录？')">
                    删除
                </a>

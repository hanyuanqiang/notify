...
<div>
    <h3 align="center">投诉建议管理</h3>
    <p style="border-top:1px solid #808080;"></p>
    <%--未回复--%>
    <p>&#9650&nbsp;未回复的投诉建议</p>
    <div>
        <c:forEach items="${noWuyeReplay}" var="data">
            <!--打印第一条信息-->
            <div class="list-group" style="width: 600px;margin-left: 20px;">
                ...
                <a href="/notify_Web/wyfw/tsjy?action=wuye&handle=showDetail&id=${data.id}" class="list-group-item">
                    <h4 class="list-group-item-heading" style="height: 5px;">
                ...
                <%--<div style="text-align: right">
                    <a class="btn btn-danger btn-xs" href="/notify_Web/wyfw/tsjy?action=wuye&handle=delete&id=${data.id}" onclick="return confirm('确定删除这条记录？')">
                        删除
                    </a>
                </div>--%>
            </div>
    ...
    <p>&#10148已回复</p>
    <div>
        <c:forEach items="${haveWuyeReplay}" var="data">
            <!--打印第一条信息-->
            <div class="list-group" style="width: 600px;margin-left: 20px;">
                <a class="list-group-item active">

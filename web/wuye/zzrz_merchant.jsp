...
<div>
    ...
    <div id="showPage">
        ...
        <table border="1" align="center" width="100%"  style="table-layout: fixed">
            <tr style="height: 30px;">
                <td width="10%" style="text-align: center">商家店家</td>
            ...
            <c:forEach items="${merchant_records}" var="data">
                <tr style="height: 30px;">
    ...
    <div hidden="hidden" id="addApply" style="border-style: solid;border-width: 2px;border-color: #1b6d85">
        <div style="margin-left: 20px">
            <h3 align="center">新建商家申请</h3>
            <form action="/notify_Web/sqfw/jdgl?handle=merchant&action=add" method="post">

                <div style="margin-top: 15px;">
                    商家店名：<input type="text" name="name" id="name" size="40"><br>
                </div>
                <div style="margin-top: 15px;">
                    商家营业执照：
                ...
                <div style="margin-top: 15px;">
                    负责人信息:
                    <textarea class="form-control" rows="5" name="principal" id="principal" style="width: 600px;"></textarea>
                </div>
                <div style="margin-top: 15px;">
                    店铺地点：<input type="text" name="location" id="location" size="40"><br>
                </div>
